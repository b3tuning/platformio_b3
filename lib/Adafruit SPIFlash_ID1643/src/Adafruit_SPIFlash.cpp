...
static const external_flash_device possible_devices[] =
										   {
												   GD25Q16C,
												   GD25Q64C,    // Main devices current Adafruit
												   S25FL116K, S25FL216K,
												   W25Q16FW,
												   W25Q64JV_IQ, // Only a handful of production run
...
//	Serial.print("Manufacturer ID : DEC : ");Serial.print(jedec_ids[0], DEC);
//	Serial.print(" Memory Type : DEC : ");Serial.print(jedec_ids[1], DEC);
//	Serial.print(" Capacity : DEC : ");Serial.println(jedec_ids[2], DEC);
//	Serial.print("Manufacturer ID : HEX : ");Serial.print(jedec_ids[0], HEX);
//	Serial.print(" Memory Type : HEX : ");Serial.print(jedec_ids[1], HEX);
//	Serial.print(" Capacity : HEX : ");Serial.print(jedec_ids[2], HEX);
...
uint32_t
Adafruit_SPIFlash::writeBuffer(uint32_t address, uint8_t const* buffer, uint32_t len) {
	if(!_flash_dev) { return 0; }
